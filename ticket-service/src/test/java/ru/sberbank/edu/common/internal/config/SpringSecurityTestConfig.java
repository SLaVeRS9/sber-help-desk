...
public class SpringSecurityTestConfig {
    ...
    public UserDetailsService userDetailsService() {
        ...
        List<GrantedAuthority> adminAndManagerAuthorities = AuthorityUtils.createAuthorityList("ROLE_ADMIN", "ROLE_MANAGER");
        ...
        UserDetails userAdminAndManager = userBuilder.username("super@mail.com").password("password").authorities(adminAndManagerAuthorities).build();

        return new InMemoryUserDetailsManager(Arrays.asList(adminUser, userUser, userAdminAndManager));
    }
}*/

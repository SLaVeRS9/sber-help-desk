...
insert into users (id, name, password, role, date_of_birth) values ('egorovamr', 'Egorova Marina', '$2a$10$Lpgs25qu/yihLyjC7/.Bbehu9OgmoNGnZ32SFggfqjpqNWrVG.ugWs', 'USER', '1993-08-11');
...
insert into tickets (title, ticket_code, requester_id, manager_id, description, created_at, status_updated_at, status) values ('title3', 'SHD-','egorovamr', 'ivanovap', 'ticket 3 very very very very very long description', '2024-01-27 12:31:00', '2024-01-28 08:45:26', 'CLOSED');

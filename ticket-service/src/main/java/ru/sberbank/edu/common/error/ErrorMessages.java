...
public class ErrorMessages {
    public final static String TICKET_EDIT_EXCEPTION = "You can't edit ticket on that status";
    public final static String TICKET_NOT_FOUND_EXCEPTION = "Ticket not found, id = ";
